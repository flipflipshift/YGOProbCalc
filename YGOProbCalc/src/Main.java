...
public class Main {
	...
	public static void main1(String args[])
	{
		...
		action("Vendor field eff").poss(cond(vend,3), move("card",1,4)).open().hopt();
	...
	public static void main2(String args[])
	{
		...
		action("Activate Desires").poss(move(desires,1,4)).draw(5,10).draw(1,2).open().hopt();
	...
	public static void main3(String args[])
	{
		...
		Action desires_eff=action("Activate Desires").poss(move(desires,1,4)).draw(5,10).draw(1,2).open().hopt();
		action("Special Souls").poss(move(souls,1,2), move(ioc,0,4)).open().hopt();
		Action souls_1=action("souls for 1").poss(cond(souls,2),move("s/t", list(1,3),4)).draw(1,1).open().hopt();
		Action souls_2=action("souls for 2").poss(cond(souls,2),move(2,"s/t", list(1,3),4)).draw(1,2).open().hopt();
		souls_1.turnoff(souls_2);
		...
		prosp_eff.turnoff(vend_field,IOC_vend,Sabres_vend,wings_eff,souls_1, souls_2, penguin_draw);
