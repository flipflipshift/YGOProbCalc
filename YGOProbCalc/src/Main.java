...
public class Main {
	public static void mainTest(String args[])
	{
		...
		Card sync4 = card("Synchro lv 4", 0, "non-tuner").numerics(4, 1);
		Card sync5 = card("Synchro lv 5", 0, "non-tuner").numerics(5,1);
		Card sync6 = card("Synchro lv 6", 0, "non-tuner").numerics(6,1);
		Card sync7 = card("Synchro lv 7", 0, "non-tuner").numerics(7,1);
		Card sync8 = card("Synchro lv 8", 0, "non-tuner").numerics(8,1);
		Card sync9 = card("Synchro lv 9", 0, "non-tuner").numerics(9,1);
		Card sync10 = card("Synchro lv 10", 0, "non-tuner").numerics(10,1);
		
		Card link2 = card("Link 2", 0).numerics(0,2);
		Card link3 = card("Link 3", 0).numerics(0,3);
		
		locations("Deck", "Hand", "Field", "GY");
		
		action("Unlimited normal").move_all(1,2).open().hopt();
		action("Synchro 4").add_poss(new Possibility(move(1, "tuner",2,3), move(1,"non-tuner",2,3), move(sync4,-1,2)).sum(4,2)).open();
		action("Synchro 4").add_poss(new Possibility(move(1, "tuner",2,3), move(2,"non-tuner",2,3), move(sync4,-1,2)).sum(4,2)).open();
		action("Synchro 5").add_poss(new Possibility(move(1, "tuner",2,3), move(1,"non-tuner",2,3), move(sync5,-1,2)).sum(5, 2)).open();
		action("Synchro 5").add_poss(new Possibility(move(1, "tuner",2,3), move(2,"non-tuner",2,3), move(sync5,-1,2)).sum(5, 2)).open();
		action("Synchro 6").add_poss(new Possibility(move(1, "tuner",2,3), move(1,"non-tuner",2,3), move(sync6,-1,2)).sum(6, 2)).open();
		action("Synchro 6").add_poss(new Possibility(move(1, "tuner",2,3), move(2,"non-tuner",2,3), move(sync6,-1,2)).sum(6, 2)).open();
		action("Synchro 7").add_poss(new Possibility(move(1, "tuner",2,3), move(1,"non-tuner",2,3), move(sync7,-1,2)).sum(7, 2)).open();
		action("Synchro 7").add_poss(new Possibility(move(1, "tuner",2,3), move(2,"non-tuner",2,3), move(sync7,-1,2)).sum(7, 2)).open();
		action("Synchro 8").add_poss(new Possibility(move(1, "tuner",2,3), move(1,"non-tuner",2,3), move(sync8,-1,2)).sum(8, 2)).open();
		action("Synchro 8").add_poss(new Possibility(move(1, "tuner",2,3), move(2,"non-tuner",2,3), move(sync8,-1,2)).sum(8, 2)).open();
		action("Synchro 9").add_poss(new Possibility(move(1, "tuner",2,3), move(1,"non-tuner",2,3), move(sync9,-1,2)).sum(9, 2)).open();
		action("Synchro 9").add_poss(new Possibility(move(1, "tuner",2,3), move(2,"non-tuner",2,3), move(sync9,-1,2)).sum(9, 2)).open();
		action("Synchro 10").add_poss(new Possibility(move(1, "tuner",2,3), move(1,"non-tuner",2,3), move(sync10,-1,2)).sum(10, 2)).open();
		action("Synchro 10").add_poss(new Possibility(move(1, "tuner",2,3), move(2,"non-tuner",2,3), move(sync10,-1,2)).sum(10, 2)).open();
		
		action("Link 2 Summon").add_poss(new Possibility(move(2, "card", 2, 3), move(link2, -1,2)).sum(1,2,1)).open();
		action("Link 3 Summon").add_poss(new Possibility(move(2, "card", 2, 3), move(link3, -1,2)).sum(1,3,1)).open();
